...
> NOTE: This repository has been converted to backend-only. The Electron desktop app (`apps/desktop`)
> has been removed from the main tree and archived in `backups/` if needed. This document is retained
