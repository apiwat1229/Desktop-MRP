...
> NOTE: The desktop app build instructions are archived — this repository is now backend-only and
> `apps/desktop` is not included. Keep this doc for reference only.
